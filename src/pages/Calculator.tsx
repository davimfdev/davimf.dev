            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-surface-1 rounded-xl border border-line shadow-inner animate-slide-up">
                <div className="md:col-span-2">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-3 bg-surface-1/50 border border-line rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-fg cursor-pointer transition-all"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        min="1"
                        className="w-full px-4 py-3 bg-surface-1/50 border border-line rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-fg transition-all"
                    />
                </div>
