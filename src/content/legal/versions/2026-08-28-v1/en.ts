  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'We use strictly necessary cookies only: the ones that keep you signed in and the ones that protect the payment form. They do not require consent because the site cannot work without them.',
          'We use no analytics, advertising or third-party tracking cookies. No measurement script is loaded on this site, which is why there is no cookie notice to accept or decline.',
          'Should we ever start measuring audience, this section will be updated first, and any measurement that requires consent will only begin after you accept.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'The site and the database are hosted in BRAZIL. Your account, your orders and your licences stay on national soil, and that part of the processing involves no international transfer.',
          'Two services process data abroad, both in the United States:',
        ],
        bullets: [
          'Resend (Plus Five Five, Inc., San Francisco, California): delivery of transactional email. Receives the recipient address and the message content, acts as a processor, relies on standard contractual clauses for the transfer, and deletes the data within 90 days of account termination.',
          'Discord (San Francisco, California): authentication, when you choose to sign in with a Discord account. Acts as an independent controller over your Discord account data, under its own privacy policy.',
        ],
      },
      {
        heading: 'Security',
