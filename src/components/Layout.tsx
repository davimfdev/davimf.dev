...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const DISCORD_AUTH_URL = "https://discord.com/api/oauth2/authorize?client_id=1484035057478799411&redirect_uri=https%3A%2F%2Fdavimf.dev%2Fapi%2Ffunctions%2Fcallback&response_type=code&scope=identify%20guilds";
  const navigation = [
