...
const Notes: React.FC = () => {
  ...
  return (
    <div className="relative" style={{ minHeight: '80vh' }}>
      ...
      <button
        onClick={createNote}
        className="fixed bottom-8 right-8 w-14 h-14 rounded-full bg-gradient-to-br from-accent to-accent/70 text-bg shadow-lg shadow-accent/30 hover:scale-110 active:scale-95 transition-transform flex items-center justify-center z-50"
        title="Nova nota"
      >
        <Plus size={24} />
      </button>
