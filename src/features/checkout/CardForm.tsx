...
const fieldShellClass =
  'w-full bg-surface-2 border border-line rounded-lg px-3.5 h-[42px] flex items-center focus-within:border-accent/60 transition-colors [&>iframe]:w-full [&>iframe]:h-full [&>iframe]:border-0';
