      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-8">
          <section className="glass-panel p-6 animate-slide-up">
            <h2 className="text-2xl font-semibold mb-6 flex items-center text-accent">
        ...
        <div className="lg:col-span-2 space-y-8">
          <section className="glass-panel p-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
            <h2 className="text-3xl font-semibold mb-8 flex items-center text-accent border-b border-white/10 pb-4">
