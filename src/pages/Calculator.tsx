        ...
        <div className="glass-panel p-8 w-full max-w-4xl mx-auto my-12 border-t-4 border-t-yellow-500 shadow-2xl animate-fade-in relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 p-6 bg-white/5 rounded-xl border border-white/10 shadow-inner animate-slide-up">
                <div className="md:col-span-2">
                    ...
                    <select
                        ...
                        className="w-full px-4 py-3 bg-surface-1/50 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-fg cursor-pointer transition-all"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        min="1"
                        className="w-full px-4 py-3 bg-surface-1/50 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-fg transition-all"
                    />
                </div>
                <div className="md:col-span-3 text-center mt-2">
                    <button
                        onClick={handleAddProduto}
                        className="w-full md:w-auto bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-bg font-bold py-3 px-8 rounded-lg transition-all transform hover:-translate-y-1 shadow-lg shadow-yellow-500/20"
                    >
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="bg-white/5 border border-white/10 p-6 rounded-xl space-y-6 shadow-inner">
                    <div className="flex items-center justify-center space-x-6 p-4 bg-surface-1/50 rounded-lg border border-white/5">
                        <span className={`font-semibold transition-colors ${!comParceria ? 'text-yellow-400' : 'text-fg-muted'}`}>{translations.calculatorWithoutPartnership}</span>
                        <label htmlFor="parceria-toggle" className="relative inline-flex items-center cursor-pointer">
                            ...
                            <div className="w-14 h-7 bg-surface-3 rounded-full peer peer-focus:ring-4 peer-focus:ring-yellow-500/30 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-1 after:left-[4px] after:bg-white after:border-line after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-yellow-500"></div>
                        </label>
                        <span className={`font-semibold transition-colors ${comParceria ? 'text-yellow-400' : 'text-fg-muted'}`}>{translations.calculatorWithPartnership}</span>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-surface-1/50 p-5 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
                        ...
                        <div className="bg-surface-1/50 p-5 rounded-xl border border-green-500/20 bg-gradient-to-br from-green-500/5 to-transparent">
                     ...
                     {itens.length > 0 && (
                        <div className="text-center pt-6 border-t border-white/10 mt-6">
                            <button
                                onClick={() => setItens([])}
                                className="px-6 py-2 rounded-lg font-medium text-red-400 hover:text-fg hover:bg-red-500 border border-red-500/30 hover:border-red-500 transition-all"
                            >
