  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Some of the services we use are operated by companies based outside Brazil, so your data may be processed or stored abroad. Depending on the case this applies to Google, Resend, Discord, Mercado Pago and the infrastructure provider of the site.',
  ...
  refund: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'On a full refund, the licence key for that order is revoked and stops working. This is the natural counterpart of the refund: the money returns to you and the product stops being usable.',
          'A partial return also suspends the key. If what you want is a price reduction while keeping the product in use, talk to us first: that request is handled differently, and the applicable conditions are explained to you before it is completed.',
        ],
      },
      {
